...
Создать в PostgreSQL 100 тестовых складских позиций на основе существующих
связей основных и дополнительных категорий:

```bash
docker compose exec api npm run db:seed
```

Команда предназначена только для разработки и при повторном запуске не создаёт
дубликаты тестовых позиций.
